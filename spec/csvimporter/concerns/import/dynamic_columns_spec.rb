...
describe Csvimporter::Import::DynamicColumns do
    ...
    describe "#dynamic_Column_attribute_objects" do
      with_this_then_context "standard columns defined" do
        it_behaves_like "attribute_objects_method",
                        %i[skills],
                        { Csvimporter::Import::DynamicColumnAttribute => 1 },
  ...
  describe "class" do
    ...
    describe "::dynamic_column" do
      it_behaves_like "dynamic_column_method", Csvimporter::Import, dynamic_column_source_cells
    end
